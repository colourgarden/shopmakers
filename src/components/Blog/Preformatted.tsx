...
import CopySuccessIcon from '../../icons/tick.svg';
import CopyErrorIcon from '../../icons/x.svg';

const Preformatted: React.FC<BlogPreformattedProps> = ({
  className,
  children,
  ...props
}) => {
  ...
  return (
    <pre
      ...
      className={`${className} group relative my-5 overflow-hidden rounded border bg-lotion`}
      {...props}>
      <button
